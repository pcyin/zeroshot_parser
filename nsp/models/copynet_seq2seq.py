...
class CopyNetSeq2Seq(Model):
    ...
    def _get_ll_contrib(self,
        ...
        print('generation_scores', torch.any(torch.isnan(generation_scores)))
        print('copy_scores', torch.any(torch.isnan(copy_scores)))
        ...
        print('step_log_likelihood', torch.any(torch.isnan(step_log_likelihood)))
